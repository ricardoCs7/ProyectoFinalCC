...
public class addFuncionController implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (comando == "crear") {
            ...
            Pelicula p = cartelera.getListadoCartelera().find(titulo);

            Funcion f = new Funcion(p, fecha, precio, precio); //CAMBIARLO SEGUN SE HARA NODO, LINKLIST O ETC (COMO POR EJEM PELICULA QUE ESTA HECHO COM
    ...
    public void llenarComboBox() {
        Pelicula current = cartelera.listadoCartelera.getFirst();     //Recorre la lista de peliculas
